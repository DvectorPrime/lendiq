...
from app.model import LoanPredictionModel
    ...
    scenarios = [
        {
            ...
            'data': {
                ...
                'housingType': 'House / apartment', 'loanAmount': 50000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'educationLevel': 'Secondary Education', 'maritalStatus': 'Single / not married', 
                'numChildren': 0, 'numFamilyMembers': 1.0, 'annualIncome': 25000, 'ownsVehicle': 0, 
                'ownsRealEstate': 0, 'housingType': 'Rented apartment', 'loanAmount': 100000, 'loanTermMonths': 60
            }
        },
        {
            'desc': 'Young Student, Short Employment',
            'data': {
                'dateOfBirth': '2001-01-10', 'employmentType': 'Other', 'employmentDurationYears': 1.5,
                ...
                'ownsRealEstate': 0, 'housingType': 'With parents', 'loanAmount': 10000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'educationLevel': 'Secondary Education', 'maritalStatus': 'Married', 
                'numChildren': 2, 'numFamilyMembers': 4.0, 'annualIncome': 40000, 'ownsVehicle': 1, 
                'ownsRealEstate': 0, 'housingType': 'House / apartment', 'loanAmount': 300000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'ownsRealEstate': 1, 'housingType': 'House / apartment', 'loanAmount': 150000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'ownsRealEstate': 1, 'housingType': 'House / apartment', 'loanAmount': 20000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'ownsRealEstate': 0, 'housingType': 'Municipal apartment', 'loanAmount': 80000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'educationLevel': 'Higher education', 'maritalStatus': 'Separated', 
                'numChildren': 1, 'numFamilyMembers': 2.0, 'annualIncome': 150000, 'ownsVehicle': 1, 
                'ownsRealEstate': 1, 'housingType': 'House / apartment', 'loanAmount': 500000, 'loanTermMonths': 60
            }
        },
        {
            ...
            'data': {
                ...
                'ownsRealEstate': 1, 'housingType': 'Other_Rented', 'loanAmount': 120000, 'loanTermMonths': 60
            }
        },
        {
            'desc': 'Unemployed Status, Missing Duration',
            'data': {
                'dateOfBirth': '1998-07-25', 'employmentType': 'Other', 'employmentDurationYears': None,
                'educationLevel': 'Secondary Education', 'maritalStatus': 'Single / not married', 
                'numChildren': 0, 'numFamilyMembers': 1.0, 'annualIncome': 10000, 'ownsVehicle': 0, 
                'ownsRealEstate': 0, 'housingType': 'With parents', 'loanAmount': 5000, 'loanTermMonths': 60
            }
        }
    ]
